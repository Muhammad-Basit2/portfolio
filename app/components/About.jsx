...
const About = () => {
  return (
    <div id='about' className='w-full px-[12%] py-10 scroll-mt-20'>
      <h4 className='text-center mb-2 text-lg font-Ovo'>Intrroduction</h4>
      <h2 className='text-center text-5xl fount-Ovo'>About me</h2>
        ...
        <div className='flex-1'>
          ...
          <ul className='grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-2xl'>
            {infoList.map(({icon, iconDark, title, description},index)=>(
              <li className='border-[0.5px] border-gray-400 rounded-xl p-6 cursor-pointer transition duration-500 hover:-translate-y-1 hover:shadow-md' 
