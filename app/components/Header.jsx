    ...
    <div className="w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4">
      <div>
        <Image
          ...
          alt=""
          className="rounded-full w-32 dark:bg-none"
          priority
        />
      </div>
      ...
      <div className="flex flex-col sm:flex-row items-center gap-4 mt-4">
        ...
        >
          ...
          <Image
            ...
            alt=""
            className="w-4 object-contain mt-1 dark:invert"
          />{" "}
        </a>
        ...
        <a
          ...
          download
          className="px-10 py-3 border rounded-full border-gray-500 dark:border-gray-400 text-gray-900 dark:text-white flex item-center gap-2 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors"
        >
          My resume{" "}
          <Image
            src={assets.download_icon}
            alt=""
            className="w-3.5 object-contain  dark:invert"
          />{" "}
        </a>
      </div>
    </div>
