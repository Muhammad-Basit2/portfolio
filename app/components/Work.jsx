    ...
    <div id="work" className="w-full px-[12%] py-10 scroll-mt-20">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 my-10">
        {workData.map((project, index) => (
          ...
          >
            <div className="bg-white w-[90%] sm:w-10/12 rounded-md absolute bottom-3 left-1/2 -translate-x-1/2 py-3 px-4 sm:px-5 flex items-center justify-between duration-500 group-hover:bottom-7">
              <div>
                <h2>{project.title}</h2>
