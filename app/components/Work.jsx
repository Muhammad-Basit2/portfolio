        ...
        {workData.map((project, index) => (
          ...
          >
            <div className="bg-white dark:bg-gray-800 w-[90%] sm:w-10/12 rounded-md absolute bottom-3 left-1/2 -translate-x-1/2 py-3 px-4 sm:px-5 flex items-center justify-between duration-500 group-hover:bottom-7">
              ...
              <div
                className="border border-black dark:border-white rounded-full w-9 aspect-square flex items-center justify-center shadow-[2px_2px_0_#000] dark:shadow-[2px_2px_0_#fff] group-hover:bg-lime-300 transition"
              >
